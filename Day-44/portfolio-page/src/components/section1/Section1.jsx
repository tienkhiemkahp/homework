...
export default function Section1() {
  ...
  return (
    <>
        <section className='container d-flex flex-column align-items-center mt-5 px-2 mx-auto'>
            <h6 className='d-block text-base font-semibold mb-4 text-blue-gray-900'>
            My awesome clients
            </h6>
            <div className='d-flex logo-wrap flex-wrap align-items-center justify-content-center gap-1'>
            {clients}
            </div>
        </section>
    </>
